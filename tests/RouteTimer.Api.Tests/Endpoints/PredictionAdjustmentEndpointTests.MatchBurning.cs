...
{
    [Fact]
    public async Task CreateAdjustment_with_valid_match_burning_returns_202_when_enabled()
    {
        ...
        var request = new VariableMatchBurningRequest(
            250, 15000, [
                new MatchBurnWindowRequest("gradient", 0.05, null, null, null, null, null, "absolute-watts", 300, null, null)
            ], 120, 0.8, 300, 0.7, true, false);
