...
[Migration("20260824080725_InitialCreate")]
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("RouteTimer.Persistence.Entities.PredictionEntity", b =>
        {
            ...
            b.Property<double>("BikeWeightKg").HasColumnType("double precision");
            b.Property<DateTimeOffset>("CreatedAt").HasColumnType("timestamp with time zone");
            b.Property<string>("ModelVersion").IsRequired().HasMaxLength(128).HasColumnType("character varying(128)");
            b.Property<double>("RiderWeightKg").HasColumnType("double precision");
            b.HasKey("Id");
        ...
        modelBuilder.Entity("RouteTimer.Persistence.Entities.StoredUploadEntity", b =>
        {
            ...
            b.Property<byte[]>("Sha256").IsRequired().HasMaxLength(32).HasColumnType("bytea");
            b.HasKey("Id");
            b.HasIndex("Kind", "Sha256").IsUnique();
