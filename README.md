...
3. **Take the result with you.** Download a completed prediction as a GPX file — plain, or with
   ...
   have a Garmin account connected. To ride it with PaceTracker, download the timed GPX and move it
   to your phone however you already move files — AirDrop, Nearby Share, or any cloud folder — then
   open it there.
